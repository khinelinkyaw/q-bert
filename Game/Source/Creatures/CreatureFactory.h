...
namespace Game
{
    ...
    public:
        static inline std::unordered_map<Creature, CreatureData> const CREATURE_TABLE =
        {
            ...
            { Creature::Slick,       { "Slick.png",    1, 8, GameEngine::Pivot::MiddleDown, {0,0},    BlockSurface::Top     }},
            { Creature::Sam,         { "Sam.png",      1, 8, GameEngine::Pivot::MiddleDown, {0,0},    BlockSurface::Top     }},
        };
