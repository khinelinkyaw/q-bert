...
namespace GameEngine
{
    namespace Constants
    {
        ...
        std::unordered_map<InputCode, int> const INPUT_CODE_MAP{
            ...
            {InputCode::KB_F1, SDL_SCANCODE_F1},
            {InputCode::KB_F2, SDL_SCANCODE_F2},
            {InputCode::KB_F3, SDL_SCANCODE_F3},
            {InputCode::KB_F4, SDL_SCANCODE_F4},
            {InputCode::KB_F5, SDL_SCANCODE_F5},
            {InputCode::KB_F6, SDL_SCANCODE_F6},
            {InputCode::KB_F7, SDL_SCANCODE_F7},
            {InputCode::KB_F8, SDL_SCANCODE_F8},
            {InputCode::KB_F9, SDL_SCANCODE_F9},
            {InputCode::KB_F10, SDL_SCANCODE_F10},
            {InputCode::KB_F11, SDL_SCANCODE_F11},
            {InputCode::KB_F12, SDL_SCANCODE_F12},
